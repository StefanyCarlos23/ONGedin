...
document.addEventListener('DOMContentLoaded', function() {
    ...
    randomEvents.forEach(event => {
        const eventLink = `ong-details.html?title=${encodeURIComponent(event.title)}&description=${encodeURIComponent(event.description)}&imgSrc=${encodeURIComponent(event.imgSrc)}`;
        ...
        eventDiv.innerHTML = `
            ...
            <div class="details">
                ...
                <div class="more-details">
                    ...
                    <a href="${eventLink}" class="btn">Ver mais</a>
                </div>
            </div>
        `;
