            ...
            <?php if (!empty($ongsSimilares)): ?>
                <?php foreach ($ongsSimilares as $index => $ong): ?>
                    <div class="ong-item" id="ong<?= $index + 1 ?>" 
                        ...
                        <div class="ong-nome">
                            <p><?= $ong['nome'] ?></p>
                            <a href="ongdetails-without-login.php?title=<?= urlencode($ong['nome']); ?>&imgSrc=<?= urlencode($ong['foto']); ?>" class="ver-mais">Ver mais</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                ...
                <?php else: ?>
                    ...
                    ?>
                        <div class="event-item">
                            ...
                            <a href="event-details-without-login.php?titulo=<?php echo urlencode($evento['titulo']); ?>" class="btn-ver-mais">Ver Mais</a>
                        </div>
                    <?php
                        $eventCount++;
                    endforeach;
